...
import { fetchBlogCardsByAuthor } from "@/services/blogServices";
import { AuthorProfileSkeleton } from "@/app/components/AuthorPageSkeleton";
...
export default function AuthorPage() {
  ...
  useEffect(() => {
    ...
    const fetchingData = async () => {
      ...
      const posts = await fetchBlogCardsByAuthor(id.toString());
      ...
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto px-4 py-12">
          <Button
            variant="ghost"
            size="sm"
            className="text-white hover:bg-white/20 mb-6 cursor-pointer"
            onClick={() => router.back()}
          >
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 mb-4">
                With expertise in{" "}
                {authorPosts.length > 0
                  ? authorPosts[0].category.name.toLowerCase()
                  : "various topics"}
            ...
            <div className="mt-8 pt-8 border-t">
              ...
              <div className="flex flex-wrap gap-2">
                {Array.from(
                  ...
                  <Badge key={category.name + index} variant="secondary">
                    {category.name}
                  </Badge>
                ))}
                {authorPosts
